...
const questions = [
  ...
  {
    question:
      "Do you always try to maintain your important role among your friends?",
    category: "Pressure",
  },
  ...
  {
    question: "Are you able to differentiate between good and bad?",
    category: "Pressure",
  },
  ...
  {
    question: "Do you complete the work within the stipulated time frame?",
    category: "Pressure",
  },
  {
  ...
  {
    question:
      "After studying for a while, do your hands and feet start twitching?",
    category: "Physical Stress",
  },
  {
  ...
  {
    question:
      "Do you not fall asleep for a long time even after going to sleep?",
    category: "Anxiety",
  },
  ...
  {
    question:
      "Do you find it intolerable to be interrupted repeatedly by your mother or father?",
    category: "Frustration",
  },
...
export default function QuizApp() {
  ...
  const handleAnswer = (isYes) => {
    ...
    setAnswers([
      ...answers,
      { category: currentCategory, value: isYes ? 1 : 0 },
    ]);
    setIndex(index + 1);
  };
            ...
            {categories.map((cat) => (
              <div key={cat} className="mb-4 text-left">
                ...
                <p className="text-sm mt-1">
                  {getCategoryScore(cat).toFixed(1)}%
                </p>
              </div>
            ))}
            <hr className="my-4" />
